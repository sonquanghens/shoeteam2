              ...
              <div class="col-sm-12">
                <table class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                          ...
                          <tr class="gradeX odd" align="center" role="row">
                                  ...
                                  <td class="center"><a  class="btn-danger btn-sm" href="{{url('/admin/branch'.'/'.$branch->id.'/delete')}}" onclick="return xacnhan('Are you sure to want DELETE')"><i class="fa fa-trash-o  fa-fw"></i>Delete</button></td>
                                  <td class="center"> <a class="btn-info btn-sm" href="{{url('/admin/branch'.'/'.$branch->id.'/edit')}}"><i class="fa fa-pencil fa-fw"></i>Edit</button></td>
                              </tr>
                            @endforeach
                          @endif
                            </tbody>
